...
def generate_protobuf_define(src: str, dist: str, proto: list, expt: list):
    ...
    with open(os.path.join(dist, 'ProtoType.generated.h'), 'w', encoding='utf-8') as file:
        file.write('''/**
 ...
 */\n\n''' % (platform.python_version(), VERSION))
        ...
        for package in proto_data:
            ...
            for proto in package['list']:
                file.write('\t\t\tcase ProtoType::%s: return "%s";\n' % (proto['proto'], proto['proto']))
    ...
    with open(os.path.join(dist, 'Protocol.generated.h'), 'w', encoding='utf-8') as file:
        file.write('''/**
